...
const handleLogout = async () => {
  ...
  try {
    ...
    if ([200, 301, 302, 303, 307, 308, 401, 403].includes(response.status) || response.type === 'opaqueredirect') {
      window.location.assign('/login')
      return
    }
  } catch (_err) {
    // Ignore network/proxy errors and fallback to app root.
  }
...
.sidebar {
  ...
  box-shadow:
    0 8px 32px rgba(30, 64, 175, 0.05),
